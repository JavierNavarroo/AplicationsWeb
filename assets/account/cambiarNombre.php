...
<body class="landing is-preload">
	...
	<!-- LOGIN -->
				<section id="banner">
				<h2>Cambiar su nombre de usuario</h2>
					<form action="procesarCambiarNombre.php" method="POST">
					<fieldset>
					<p>Nuevo nombre: <input type="text" name="username" placeholder="Enter your new name"/></p>
